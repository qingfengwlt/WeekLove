 ...
 *  fg 导师
 */
public class TeacherTabFragment extends BaseFragment {
    ...
    public static TeacherTabFragment newInstance(int colorId) {
...
//        mTvRight.setText("筛选");
        ...
        mAdapter =new CommonAdapter<String>(getActivity(),mList,R.layout.list_item_fg_teacher) {
            @Override
