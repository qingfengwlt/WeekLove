 ...
 * Use the {@link VipTabFragment#newInstance} factory method to
...
public class VipTabFragment extends BaseFragment {
   ...
   @BindView(R.id.lv_vip)
    ...
    public static VipTabFragment newInstance(int colorId) {
        VipTabFragment fragment = new VipTabFragment();
    ...
    private void initData() {
        ...
        mAdapter =new CommonAdapter<String>(getActivity(),mList,R.layout.list_item_fg_vip) {
            @Override
