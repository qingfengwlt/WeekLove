 ...
 * Use the {@link WelcomeTwoFragment#newInstance} factory method to
...
public class WelcomeTwoFragment extends BaseFragment {
     ...
     */
    public static WelcomeTwoFragment newInstance(int positon) {
        WelcomeTwoFragment fragment = new WelcomeTwoFragment();
    ...
    protected int resLayout() {
        return R.layout.fg_welcome_two;
    }
}
